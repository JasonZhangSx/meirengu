    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            <div class="cl pd-5 bg-1 bk-gray mt-20">
  				<span class="l">
            <a class="btn btn-primary radius" onClick="organization_detail('系统管理-部门管理-添加','detail','')"  href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添 加</a>
          </span>
            </div>
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <c:forEach items="${organizationList}" var="r">
                        <tr class="text-c">
                            <td>${r.organizationId}</td>
                            <td>${r.organizationName}</td>
                            <c:choose>
                                <c:when test="${r.organizationStatus == 1}">
                                    <td>启用</td>
                                </c:when>
                                <c:otherwise>
                                    <td>禁用</td>
                            ...
                            <td>${r.organizationSort}</td>
                            <td class="f-14 td-manage">
                                <a title="编辑" href="javascript:;" onclick="organization_detail('系统-部门管理-编辑','detail',${r.organizationId})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                                <a title="删除" href="javascript:;" onclick="organization_remove(this,${r.organizationId})" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
...
//        "aaSorting": [[0, "asc"]],
    ...
    //*角色-添加*/
    function organization_detail(title, url, id, w, h) {
    ...
    /*操作员禁用*/
    function organization_remove(obj,id){
