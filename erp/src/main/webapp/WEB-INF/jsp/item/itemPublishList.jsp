...
<section class="Hui-article-box" style="top: 0; left: 0;">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 众筹项目 <span class="c-gray en">&gt;</span> 待发布项目列表 <a
                        ...
                        <tr class="text-c">
                            ...
                            <td class="f-14 td-manage">
                                <a style="text-decoration:none" class="ml-5"
                                   onClick="project_edit('众筹-待发布项目列表-详情','item/to_publish?itemId=${item.itemId}','10001')" href="javascript:;"
                                title="发布设置">发布设置</a>
                            </td>
                        </tr>
                    </c:forEach>
