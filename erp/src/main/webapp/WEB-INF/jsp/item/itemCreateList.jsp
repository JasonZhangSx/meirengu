...
<section class="Hui-article-box" style="left:0;top:0">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 众筹项目管理 <span class="c-gray en">&gt;</span>新建项目列表 <a
    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l"><a class="btn btn-primary radius" onClick="project_edit('添加项目信息','item/to_add')"
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        table = $('#dt').DataTable({
            ...
            'ajax': {
                'url': '<%=basePath %>item/query?status=1,4'
            },
