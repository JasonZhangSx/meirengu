...
<section class="Hui-article-box" style="left:0;top:0">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 众筹项目管理 <span class="c-gray en">&gt;</span>待合作项目列表 <a
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        table = $('#dt').DataTable({
            ...
            'ajax': {
                'url': '<%=basePath %>item/query?status=3'
            },
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        {
                            func: [
                                {"name": "设置", "fn": "detail(\'" + row.itemId + "\')", "type": "primary"}
                            ]
                        };
    ...
    function detail(id){
        var index = layer.open({
            type: 2,
            title: "待合作项目详情",
            content: "item/to_cooperate?itemId="+id
        });
        layer.full(index);
    }
</script>
