...
<section class="Hui-article-box" style="left:0;top:0">
    <nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 众筹项目管理 <span class="c-gray en">&gt;</span>已发布项目列表 <a
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        table = $('#dt').DataTable({
            ...
            'ajax': {
                'url': '<%=basePath %>item/query?status=10,11'
            },
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "render": function (data, type, row, meta) {
                        ...
                        {
                            func: [
                                {"name": "查看", "fn": "detail(\'" + row.itemId + "\')", "type": "default"},
