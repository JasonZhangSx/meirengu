        ...
        <article class="cl pd-20">
            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <tbody>
                    <c:forEach items="${paymentCollectionRecord}" var="paymentCollection">
                        <tr class="text-c">
                            ...
                            <td>${paymentCollection.shouldSmount}</td>
                            <td>${paymentCollection.actualAmount}</td>
                            <c:choose>
                                <c:when test="${paymentCollection.collectionType==1}">
                                    <td>预付</td>
                                </c:when>
                                <c:when test="${paymentCollection.collectionType==2}">
                                    <td>线下付款</td>
                                </c:when>
                            </c:choose>
                            ...
                            <c:choose>
                                <c:when test="${paymentCollection.collectionTime != null}">
                                    <td>
                                        <c:set var="collectionTime" value="${paymentCollection.collectionTime}" scope="session"/>
