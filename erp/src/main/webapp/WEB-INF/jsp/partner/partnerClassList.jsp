    ...
    <div class="Hui-article">
        <article class="cl pd-20">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
                <span class="l"><a class="btn btn-primary radius" onClick="project_edit('添加行业分类信息','partner/class/detail')"
                                   href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加行业分类</a></span>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        table = $('#dt').DataTable({
            ...
            'ajax': {
                'url': '<%=basePath %>partner/class/query'
            },
    ...
    function detail(id){
        var index = layer.open({
            type: 2,
            title: "行业分类修改",
            content: "partner/class/detail?id="+id
        });
        layer.full(index);
    }
</script>
