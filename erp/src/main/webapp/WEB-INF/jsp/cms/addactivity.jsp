...
<div class="page-container">
    <form action="activity" method="post" id="form-horizontal" class="form form-horizontal" enctype="multipart/form-data" id="form-article-add">
        ...
        <div>
            <div class="row cl">
                <h3 class="edit_h31 col-sm-9 col-sm-offset-1 col-xs-offset-0 mb-10 pb-10">添 加 活 动</h3>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">活动名称：</label>
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="" maxlength="20"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8">
                    <input type="text" class="input-text" value="" id="activity_link" name="activity_link"
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="datetime" class="input-text" value="" placeholder="" id="datetimepicker3" name="end_time">
                </div>
            </div>
            <br/><br/>
            <div class="row cl">
