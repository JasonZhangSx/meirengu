...
<div class="page-container">
    <form action="/erp/activity/update" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-article-add">
        <style>
            .edit_h31 {
        ...
        <div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="<fmt:formatDate value="${startDate}" pattern="yyyy-MM-dd"/>" placeholder="" name="start_time">
                </div>
                <label class="form-label col-xs-4 col-sm-2">结束时间：</label>
                <div class="formControls col-xs-8 col-sm-3">
                    <input type="text" class="input-text" value="<fmt:formatDate value="${endDate}" pattern="yyyy-MM-dd"/>" placeholder="" id="datetimepicker3" name="end_time">
                </div>
            </div>
            <br/><br/>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-8 text-c">
                    <button class="btn btn-primary radius size-L mt-20 mb-30" style="padding:0 30px" type="submit">保 存
                    </button>
                </div>
            </div>
