        ...
        <article class="cl pd-20">
          <%--  <div class="text-c">
            ...
            <div class="cl pd-5 bg-1 bk-gray mt-20">
  				<span class="l">
            <a class="btn btn-primary radius" onClick="project_edit('CMS-常见问题列表-添加问题','faq/toadd','10001')"
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        if(row.status=='0'){
                            return '<td class="f-14 td-manage">' +
                                    ...
                                    'onclick="project_edit(\'CMS-常见问题-修改\',\'faq/toedit\','+row.faqId+')" href="javascript:;" title="项目编辑">' +
                        ...
                        if(row.status=='1'){
                            return ' <td class="f-14 td-manage">' +
                                    ...
                                    '<a style="text-decoration:none" class="ml-5"' +
                                    'onClick="project_edit(\'CMS-常见问题-修改\',\'faq/toedit\','+row.faqId+')" href="javascript:;"title="项目编辑"><i class="Hui-iconfont">&#xe6df;' +
                                    '</i></a>' +
                                    '</td>';
                        }else{
