...
<div class="page-container">
    ...
    <span class="form form-horizontal" id="form-article-add">
        <!-- 内容设置 -->
        <div class="row cl">
            <h3 class="edit_h31 col-sm-9 col-sm-offset-1 col-xs-offset-0 mb-10 pb-10 mt-20">公告修改</h3>
        </div>
        <div class="content_set">

            <form action="bulletin/update" method="post" id="bulletinUpdateForm">
                <input type="hidden" name="bulletinId" value="${bulletin.bulletinId}">
                <input type="hidden" id="bulletinContentValue" value="${bulletin.bulletinContent}">
                <div class="item">
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-2">公告名称：</label>
                        <div class="formControls col-xs-8 col-sm-8">
                            <input type="text" class="input-text" value="${bulletin.bulletinTitle}" maxlength="30" placeholder="项目标题最多30字" id="bulletinTitle"
                                   name="bulletinTitle">
                        </div>
                    </div>
                    <div class="row cl">
                    ...
                    <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2 mt-30 mb-20">
                        <button class="btn btn-primary radius" id="contentAddBtn1" type="button" onclick="bulletinUpdate()"><i
...
<script type="text/javascript">
    $(function(){
        $('#bulletinContent').val("${bulletin.bulletinContent}");
    });
...
//            '\n\nThe output div should have already been updated with the responseText.');
    ...
    function bulletinUpdate() {
        $('#bulletinUpdateForm').ajaxSubmit(options);
    }
</script>
</body>
</html>
