...
//        }
        ...
        while ((i * num) < strList.size()) {
            ...
            k += redisService.lpush("ttt",a);
            i++;
        }
        k += redisService.lpush("ttt", strList.subList((i - 1) * num, strList.size()).toArray(new String[(strList.size() - (i - 1) * num)]));
