...
import static com.meirengu.utils.TimeUtil.tilNextMillis;
import static com.meirengu.utils.TimeUtil.timeGen;
...
public class InstaIdGenerator {
	...
	protected static final Logger LOG = LoggerFactory.getLogger(InstaIdGenerator.class);
