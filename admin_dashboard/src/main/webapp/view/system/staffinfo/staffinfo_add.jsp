...
<form id="hospitalDataForm"  enctype="multipart/form-data" action="/hospital" class="form-horizontal" method="post" onsubmit="return saveReport();"> >
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="file" name="certificatePicOne_700_700" multiple="multiple"  class="form-control input-sm"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-5">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="file" name="hospitalPic_200_200" multiple="multiple"  class="form-control input-sm"/>
                </div>
            </div>
