...
<form id="hospitalDataForm"  enctype="multipart/form-data" action="<%=path%>/hospital/update" class="form-horizontal" method="post" onsubmit="return saveReport();"> >
    <h5 class="page-header alert-info" style="padding:10px; margin:0px; margin-bottom:5px;">基本信息</h5>
    <c:forEach items="${map.data.list}" var="h">
        <input type="hidden" name="hospitalId" value="${h.hospitalId}"/>
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    <label class="col-sm-3 control-label">医院名称</label>
                    <div class="col-sm-9">
                        <input type="text" value="${h.hospitalName}" name="hospitalName"   class="form-control input-sm" placeholder="请输入医院名称"/>
                    </div>
                </div>
            </div>
            <div class="col-sm-5">
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="${h.hospitalWebsite}" name="hospitalWebsite" class="form-control input-sm" placeholder="请输入医院网站"/>
                    </div>
                </div>
            ...
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"   value="${h.hospitalAddress}" name="hospitalAddress" class="form-control input-sm" placeholder="请输入医院地址"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="${h.hospitalTel}" name="hospitalTel" class="form-control input-sm" placeholder="请输入医院电话"/>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="${h.contacts}"  name="contacts" class="form-control input-sm" placeholder="请输入联系人名称"/>
                    </div>
                </div>
            ...
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text"  value="${h.contactsTel}"  name="contactsTel" class="form-control input-sm" placeholder="请输入联系人电话"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-5">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="email"  value="${h.email}"  class="form-control input-sm" placeholder="请输入联系邮箱 "/>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-sm-10">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <textarea class="form-control" name="hospitalRemark">${h.hospitalRemark}</textarea>
                    </div>
                </div>
