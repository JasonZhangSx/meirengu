    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <%--<li class="active">--%>
                    <%--<a--%>
                            <%--href="<%=path%>/view/service/serviceCodeCheck.jsp" target="mainframe">--%>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <c:forEach var="itemList" items="${item.list}" varStatus="status">
                                <li><a href="<%=path%>${itemList.value}" target="mainframe"> <i
                                        class="icon-double-angle-right"></i> ${itemList.name}
                                </a>
                                </li>
                            </c:forEach>
                                <%--<li><a href="view/system/roleinfo/roleinfo_list.jsp" target="mainframe"> <i--%>
                                <%--class="icon-double-angle-right"></i> 角色管理--%>
                                <%--</a></li>--%>
                                <%--<li><a href="view/system/roleinfo/staffinfo_role_list.jsp" target="mainframe"> <i--%>
                                <%--class="icon-double-angle-right"></i> 角色变更	</a></li>--%>
                                <%--<li><a href="view/system/anthorty/anthorty_list.jsp" target="mainframe"> <i--%>
                                <%--class="icon-double-angle-right"></i> 权限管理	</a></li>--%>
                                <%--<li><a href="view/system/anthotychange/anthorty_changelist.jsp" target="mainframe"> <i--%>
                                <%--class="icon-double-angle-right"></i> 权限变更</a></li>--%>
                                <%--<li><a href="view/system/datadictionary/datadictionary_list.jsp" target="mainframe"> <i--%>
                ...
                <%--<li><a href="/index/login.do" target="mainframe"> <i--%>
        ...
        <div class="main-content" id="mains">
            <iframe id="mainframe" name="mainframe" src="<%=path%>/view/service/serviceCodeCheck.jsp"
            ...
            <div class="ace-settings-box" id="ace-settings-box">
                ...
                <div>
                    <input type="checkbox" class="ace ace-checkbox-2"
                           id="ace-settings-navbar" checked="checked" /> <label class="lbl"
...
<script type="text/javascript">
    if ("ontouchend" in document)
        document
                .write("<script src='<%=path%>/assets/js/jquery.mobile.custom.min.js'>"
                        + "<"+"script>");
</script>
