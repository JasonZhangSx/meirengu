...
public class WxPaySendData {
    ...
    /**
     * 商品描述	body	是	String(128)	腾讯充值中心-QQ会员充值 商品简单描述，该字段请按照规范传递
     */
    private String body;
    /**
     * 商品详情 	否 	String(8192) 	Ipad mini  16G  白色 	商品名称明细列表
     */
    ...
    /**
     * 商户订单号	out_trade_no	是	String(32)	20150806125346	商户系统内部订单号，要求32个字符内、且在同一个商户号下唯一。
     */
    ...
    /**
     * 商品标记	goods_tag	否	String(32)	WXG	商品标记，使用代金券或立减优惠功能时需要的参数
     */
     ...
     * openid如何获取，可参考【获取openid】。企业号请使用【企业号OAuth2.0接口】获取企业号内成员userid，
