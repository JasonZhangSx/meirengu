...
public class TestNullMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        testNull = new TestNull();
        List<TestNull.TestNullChlidB> testNullChlid1 = new ArrayList<TestNull.TestNullChlidB>();
        testNullChlid1.add(null);
        testNull.setTestNullChlid1(testNullChlid1);
        Map<String, TestNull.TestNullChlidB> testNullChlid2 = new HashMap<String, TestNull.TestNullChlidB>();
        ...
        testNull = new TestNull();
        TestNull.TestNullChlidB[] testNullChlidB3 = new TestNull.TestNullChlidB[1];
