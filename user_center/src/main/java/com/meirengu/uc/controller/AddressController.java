...
public class AddressController extends BaseController {
    ...
    public Result showProvinceList() {
        ...
        try {
            ...
            logger.error("AddressController.showProvinceList throws Exception :{}",e.getMessage());
    ...
    public Result showCityListByPid(int pid){
        ...
        try {
            ...
            logger.error("AddressController.showCityListByPid throws Exception :{}",e.getMessage());
            return super.setResult(StatusCode.INTERNAL_SERVER_ERROR, null, StatusCode.codeMsgMap.get(StatusCode.INTERNAL_SERVER_ERROR));
        }
    }
    /**
    ...
    public Result showAreasByCityId(Integer citys_id){
        ...
        try {
            ...
            logger.error("AddressController.showAreasByCityId  throws Exception :{}",e.getMessage());
            return super.setResult(StatusCode.INTERNAL_SERVER_ERROR, null, StatusCode.codeMsgMap.get(StatusCode.INTERNAL_SERVER_ERROR));
        }
   ...
   @RequestMapping(value = "/superarea",method = RequestMethod.GET)
    public Result showProByCityId(Integer area_id){
       try {
           ...
           logger.error("AddressController.showProByCityId throws Exception :{}",e.getMessage());
           return super.setResult(StatusCode.INTERNAL_SERVER_ERROR, null, StatusCode.codeMsgMap.get(StatusCode.INTERNAL_SERVER_ERROR));
       }
