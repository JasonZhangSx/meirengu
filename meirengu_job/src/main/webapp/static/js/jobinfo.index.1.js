$(function() {
    ...
    $('#startTime,#startTime2').datetimepicker({
	...
	$("#job_list").on('click', '.update',function() {
        ...
        $('#updateModal .form select[name=triggerType] option[value='+ row.triggerType +']').prop('selected', true);
        $("#updateModal .form input[name='startTime']").val( moment(new Date(row.startTime)).format("YYYY-MM-DD HH:mm:ss") );
