package com.meirengu.mj.core.util;
...
public class MailUtil {
	...
	static{
		host = PropertiesUtil.getString("job.mail.host");
		port = PropertiesUtil.getString("job.mail.port");
		username = PropertiesUtil.getString("job.mail.username");
		password = PropertiesUtil.getString("job.mail.password");
		sendFrom = PropertiesUtil.getString("job.mail.sendFrom");
		sendNick = PropertiesUtil.getString("job.mail.sendNick");
	}
...
//					while(total < 10){
						...
						sendMail("381775433@qq.com", "测试邮件", mailBody, false, null);
