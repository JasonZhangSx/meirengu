package com.meirengu.mj.controller.interceptor;

import com.meirengu.mj.controller.annotation.PermessionLimit;
import com.meirengu.mj.core.util.CookieUtil;
...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
    ...
    static {
        String username = PropertiesUtil.getString("job.login.username");
        String password = PropertiesUtil.getString("job.login.password");
